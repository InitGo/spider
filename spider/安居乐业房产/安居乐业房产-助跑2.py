...
city_url = 'http://f.51-maifang.com/index.php?caid=2&addno=1&ccid1=5064'
city_name = '佛山'
print(city_url,city_name)
flag_list = all_page_urls(city_url,1,10) #输入开始和终止页面 惠州 共33 惠州市全 固安9 石家庄12 重庆32 宁波12 苏州37 南通市15 无锡11 北海4 昆山市11 衡水6 佛山10
