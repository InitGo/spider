...
city_url = 'http://f.51-maifang.com/index.php?caid=2&ccid1=5063&addno=1'
city_name = '肇庆'
print(city_url,city_name)
flag_list = all_page_urls(city_url,1,1) #输入开始和终止页面 烟台全 保定全 滁州16全 嘉兴22 绍兴市18 威海15 马鞍山市9 郑州13 芜湖8 东莞14 承德7 西安7 肇庆
for flag_url in flag_list:
    print('现在正在处理这一flag：')
    print(flag_url)
    info_list = get_info(flag_url)#已得到每条flag的信息
    #把infolist写入csvyantai
